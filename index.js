data =
    [
...

        {
            ...
            "longTermVision": "I like to be a full stack developer in modern web Technologies and a data scientist.",
            "motivatesMe": "",
        ...
        ,
        {
            ...
            "whySofterDeveloper": "Because i am intrested to learn the tech industry and software developer is the start of it.",
        ...
        ,
        {
            "firstName": "Abdirahmaan",
            "lastName": "Ahmed",
            "title": "software programmer ",
            "nationality": "finnish",
            "src": "abdirahmaan_ahmed.jpg",
            "alt": "Abdirhamaan Ahmed",
            "skills": ["HTML", "CSS", "JavaScript", "Jquery"],
            "whySofterDeveloper": "",
            "longTermVision": "Buisness man",
            "motivatesMe": "future",
            "favoriteQuote": "Rome was not built in a day!",
            "joinedOn": "04-12-2017"
        }
        ,
        {
        ...
        ,
        {
            ...
            "favoriteQuote": "what doesen't kill you makes you stronger",
            "joinedOn": "04-12-2017"
        }
        ,
        {
        ...
        },
        {
            ...
            "longTermVision": "Being a good role model for others",
            "motivatesMe": "Learn from your mistakes, Never let your failures brings you down",
            "favoriteQuote": "Be like yourself. There will be nobody with you always to motivate you. Its you alone can love yourself and motivate yourself",
            "joinedOn": "16.02.2018"
        },
...
renderStudent = (data) => {
    let result = `<div class="student">
                <img src="./Photo wall/${data.src}" alt="${data.alt}">
                <div class="buttonFunction">
                        <button><i class="fas fa-ellipsis-h" id="toggleInfo" onclick="toggleInfo()"></i></button>
                        <button><i class="fas fa-arrow-right" id="changeStudent" onclick="changeStudent()"></i></button>
                </div>
                <div id="studentInfoToggle" class="studentInfo">
                    ...
                    <div class="otherInfo">
                        ...
                        <a onclick="toggleSkills()"><i class="fas fa-caret-down"></i> Skills: ${data.skills.length}</a>
                            <ul id="skills" class="hide">
                                ${data.skills.map((skill, index) => `<li key={${index}}>${skill}</li>`).join("")}
                            </ul>
                        <p>Why software Developer: ${data.whySofterDeveloper}</p>
                        <p>Vision: ${data.longTermVision}</p>
                        <p>Motivation: ${data.motivatesMe}</p>
                        <p>Favourite Quote: ${data.favoriteQuote}</p>
                        <p>Date Joined: ${data.joinedOn}</p>
                    </div>
                </div>
            </div>`;
    document.getElementById("studentWrapper").innerHTML = result;
}

let count = 0;

if(data.length) {
    renderStudent(data[count]);
}

changeStudent = () => {
    count < data.length ? count++ : count = 0;
...
toggleInfo = () => {
    document.getElementById("studentInfoToggle").classList.toggle('hide');
}
...
toggleSkills = () => {
    ...
    // ${skills.classList.contains('hide') ? `<i class="fas fa-caret-down"></i>` : `<i class="fas fa-caret-right"></i>`}
}
